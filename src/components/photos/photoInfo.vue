        ...
        <div class="mui-card-content">
          <div class="mui-card-content-inner pro-info">
            ...
            <div class="number-box">
              购买数量：
              <number-box @getcount="getSelectedCount" :maxNum="proDetail.stock_quantity"></number-box>
            </div>
            <p class="choose-btn">
      ...
      <div class="mui-card">
        ...
        <div class="mui-card-content">
          <div class="mui-card-content-inner pro-info">
            <p>
              商品货号：
              <span>{{ proDetail.goods_no }}</span>
            </p>
            <p>
              库存情况：
              <span>{{ proDetail.stock_quantity }}</span>
            </p>
            <p>
              上架时间：
              <span>{{ proDetail.add_time | format }}</span>
            </p>
          </div>
        </div>
